...
router.post("/chat", AuthenticateUser, chatUser)
router.post("/post", AuthenticateUser, postUser)
router.get("/getAll", AuthenticateUser, getAll)
router.post("/likes", AuthenticateUser, likesLogic)
router.post("/showLike", AuthenticateUser, showLikeButtonLogic)
router.post("/dontshowLike", AuthenticateUser, dontShowLikeButtonLogic)
router.post("/getPostLikes", AuthenticateUser, getPostLikes)
